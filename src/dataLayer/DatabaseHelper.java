...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	static final String profileTable = "Profile"; // Declaring constant for
													// Database
	static final String profileName = "Name";
	static final String latitude = "latitude";
	static final String longtitude = "longtitude";

	static final String contactTable = "contact_profile"; // Declaring constants
															// for Database
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + contactTable + " ( " + contactName
				+ "  , " + profileName_blocked
				+ " TEXT,  PRIMARY KEY(contact_name,Profile) )");
	...
	public Cursor getAllProfiles() {
		...
		Cursor c = db
				.query(profileTable, columns, null, null, null, null, null);
		return c;
	 ...
	 * @return double array of given colomn
	 */
	 ...
	 * @return if an error occured during the adding false will be retruned if
	 *         successfully added true will be returned
	 */
	 ...
	 * 
	 * @param ProfileName
	 * @return an array of Strings whcih inculeds the relevent data about
	 *         profile
	 */
	...
	public String[] getData(String ProfileName) {
		...
		SQLiteDatabase db = getReadableDatabase();
		String[] columns = new String[] { profileName, latitude, longtitude };
		Cursor cursor = db.query(profileTable, columns, "Name like " + "'"
				+ ProfileName + "'", null, null, null, null);
	 ...
	 * @return true if the geven string is found in the given given array
	 */
	 ...
	 * 
	 * @param profName
	 * @return true if successfully deleted, if not deleted false
	 */
	 ...
	 * 
	 * @param profName
	 *            the name of the profile which wants to be updated
	 * @param lattitude
	 *            the altered data
	 * @param longtitude
	 *            the altered data
	 * @return return true if successfully updated retruns false if not updated
	 */
	public boolean updateProfile(String profName, Double lattitude,
			Double longtitude) {
	 ...
	 * 
	 * @param profName
	 *            The name of the profile which wants to be deleted
	 * @return true if successfully delete the given profile returns false if
	 *         failed to delete
	 */
	 ...
	 * 
	 * @param latitude
	 *            current place lattitude
	 * @param longtitude
	 *            current place longtitude
	 * @return array of String which contains relevent profiles with given
	...
	public String[] getProfNameFromCordinates(Double latitude, Double longtitude) {
		...
		Cursor cursor = db.query(profileTable, columns, " latitude BETWEEN "
				+ leftLatLimit + " AND " + rightLatLimit
				+ " AND longtitude BETWEEN " + LeftLongLimit + " AND "
				+ rightLongLimit, null, null, null, null);
		String name[] = cursorToStringArray(cursor, profileName);
	 ...
	 * @param profiles
	 *            A Geo profile name
	 * @return The set of contacts which are blocked under the given geo profile
	 */
	 ...
	 * @param arrayList
	 *            An array list
	 * @return An array of the given array list
	 */
	 ...
	 * @param cursor
	 * @param ColomnName
	 *            The name of the colomn which the data is needed
	 * @return the data as an array list which is in the specified colomn
	 */
